...
x_num = np.linspace(0, 100, n_samples)

# Generate a target variable (y) with a linear probability (0% to 100%)
# This creates a perfect monotonic relationship for testing WoE/IV
y_num = (np.random.rand(n_samples) < (x_num / 100)).astype(np.int32)
