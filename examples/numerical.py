...
numerical_binning = fastbinning.NumericalBinning(max_bins=10, initial_bins_count=500)
...
print("-" * 70)
print(f"{'ID':<3} | {'Range':<25} | {'WoE':<8} | {'IV':<8} | {'Missing'}")
print("-" * 70)
...
for b in bins:
    ...
    print(
        f"{b.bin_id:<3} | {range_str:<25} | {b.woe:>8.4f} | {b.iv:>8.4f} | {b.is_missing}"
    )
    total_iv += b.iv
